...
## to rendering file, reponsible to picking up all file present in templates folder
from fastapi.templating import Jinja2Templates
templates = Jinja2Templates(directory="./templates")

##lets create home page in fast api and show every api present
...
@app.post("/predict")
async def predict_route(request: Request,file: UploadFile = File(...)):    ## we can upload file by this
    try:
        ...
        table_html = df.to_html(classes='table table-striped')    ##this info , we make amd paste as table on html file
        #print(table_html)
