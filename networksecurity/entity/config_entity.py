...
## for DATA Validation Config:
class DataValidationConfig:  ## first Artifacts folder will create and then in that folder all this fplder and files will created
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
